...
public class ModifierMain01 {
    ...
    public static void main(String[] args) {
        ...
        // test.a = 10; // private은 다른 클래스에서 보이지 않음. 직접 접근이 안됨.
        test.b = 20; // package 맴버는 같은 패키지의 클래스에서 보임. 직접 접근 가능.
        test.printMembers(); //  간접접근으로 private 도 접근 가능. public 메서드를 이용해서 private 맴버 변수를 간접적으로 사용.
