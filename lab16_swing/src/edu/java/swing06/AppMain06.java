...
//                JOptionPane.showMessageDialog(frame, "안녕하세요.");
        ...
        btnMsgDlg.setBounds(12, 10, 410, 54);
...
//                int result = JOptionPane.showConfirmDialog(frame, "삭제할까요?");
                int result = JOptionPane.showConfirmDialog(
                        frame, // 다이얼로그의 부모 컨포넌트
                        "선택한 파일을 삭제할까요?", // 다이얼로그의 메세지
        ...
        btnConfirmDlg.setBounds(12, 74, 410, 54);
        ...
        btnOptionDlg.setFont(new Font("D2Coding", Font.PLAIN, 20));
        btnOptionDlg.setBounds(12, 138, 410, 54);
...
//                String input = JOptionPane.showInputDialog("이름?");
                //-> OK버튼을 클릭하면 입력한 내용이 리턴, Cancel을 클릭하면 빈 문자열을 리턴.
//                String input = JOptionPane.showInputDialog(frame, "이름");
        ...
        btnInputDlg.setBounds(12, 202, 410, 54);
        ...
        btnCustomDlg.setBounds(12, 266, 410, 54);
        ...
        btnCustomFrame.setBounds(12, 330, 410, 54);
