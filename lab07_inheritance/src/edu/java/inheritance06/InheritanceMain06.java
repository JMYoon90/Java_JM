...
public class InheritanceMain06 {
    ...
    public static void main(String[] args) {
        ...
        // -> 자바의 모든 클래스 Object 클래스의 public 멤버(변수, 메서드)를 사용할 수 있음, 재정의(override)할 수 있음.
        ...
        // -> Ojbect의 toString() 메서드를 하위 클래스에서 override하면 콘솔창에 출력을 바꿀 수 있음.
        ...
        // 객체들이 가지고 있는 멤버들의 값으로 비교하고 싶을 떄는 equals() 메서드를 재정의함.
