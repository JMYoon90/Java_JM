 ...
 * 
 * HasgSet<E>: 검색을 빠르게 하기 위한 Set.
 * TreeSet<E>: 정렬을 빠르게 하기 위한 Set.
 * 
 * Map<K, V>
...
public class MapMain01 {
    ...
    public static void main(String[] args) {
        ...
        // remove(K): Key에 맵핑된 Key-value 원소를 삭제하고, 삭제한 value(값)을 리턴.
        map.remove(1);
        System.out.println(map);
        
        // remove() 메서드는 key에 매핑된 key-value 원소가 없으면 null을 리턴.(에러 발생 x)
        map.remove(2);
        System.out.println(map);
