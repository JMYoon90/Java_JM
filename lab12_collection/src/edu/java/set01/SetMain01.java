...
public class SetMain01 {
    ...
    public static void main(String[] args) {
        ...
        set.add("hello"); // 중복값 저장 x
        System.out.println(set);

        set.add("apple");
        System.out.println(set);
        
        set.add("banana"); // Treeset은 자동으로 정렬.
        System.out.println(set);
        
        set.add("zip");
        System.out.println(set);
        
        // Set은 for 문장을 사용할 수 없지만 for-each문장과 Iterator<E>를 사용할 수 있음.
        for(String s : set) {
            System.out.print(s + ", ");
        }
        System.out.println();
        ...
        // -> descendingIterator() 메서드는 정렬 기능을 가지고 있는 TressSet만 가지고 있음.
