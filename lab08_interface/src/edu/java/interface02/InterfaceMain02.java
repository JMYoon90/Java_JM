...
//      -> 인터페이스에 [public] default 메서드 안에서만 사용하기 위한 목적의 메서드.
...
interface Test{
    ...
    // 3. [public] default 메서드 - Java 8부터 사용가능
    default void defaultMethod() {
        System.out.println("공개 디폴드 메서드");
    }
    
    // 4. [public] static 메서드 - Java 8부터 사용가능
    static void staticMethod() {
        System.out.println("공개 static 메서드");
        privateStaticMethod();
    }
    
    // 5. private static 메서드 - Java 9부터 사용가능
