...
public class BlogMain implements OnBlogInsertListener, OnBlogUpdateListener {
    ...
    private void initialize() {
        ...
        JButton btnLeadAll = new JButton("전체 보기");
        ...
        btnLeadAll.setFont(new Font("D2Coding", Font.PLAIN, 24));
        buttonPanel.add(btnLeadAll);
    ...
    private void searchBlogsByKeyword() {
    	...
    	// DAO 에 검색 타입과 검색어를 argument로 갖는 검색 메서드 호출.
